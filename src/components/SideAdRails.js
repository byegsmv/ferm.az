  ...
  const placeholder = (
    ...
    >
      ...
      <div className="relative h-full flex flex-col items-center justify-center gap-[13cqw] px-[12cqw] text-center">
        ...
        >
          <span className="inline-flex items-center gap-[2cqw]">
            <svg viewBox="0 0 24 24" className="w-[10cqw] h-[10cqw] fill-white" aria-hidden="true">
            ...
            <span className="text-[9.4cqw] font-black tracking-wide text-white">223 89 89</span>
          </span>
        </a>
      </div>
    </div>
