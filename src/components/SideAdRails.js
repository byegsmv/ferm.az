...
export default function SideAdRails({ left, right, whatsappUrl }) {
  ...
  const placeholder = (
    ...
    >
      ...
      <div className="relative h-full flex flex-col items-center justify-center gap-[13cqw] px-[12cqw] text-center">
        <div>
          <p className="text-[5.5cqw] font-bold uppercase tracking-[0.3em] text-amber-300/90">Premium</p>
          <h3 className="mt-[3cqw] text-[13.5cqw] font-black leading-[1.15] text-white drop-shadow-md">
        ...
        <a
          ...
          className="inline-flex flex-col items-center gap-1 rounded-[8cqw] bg-[#25D366] px-[12.5cqw] py-[7.5cqw] shadow-lg shadow-emerald-950/50 transition-transform duration-200 hover:scale-105 active:scale-95"
        >
          <span className="inline-flex flex-col items-center gap-[2.5cqw]">
            <svg viewBox="0 0 24 24" className="w-[11cqw] h-[11cqw] fill-white" aria-hidden="true">
            ...
            <span className="text-[8cqw] font-black tracking-wide text-white">223 89 89</span>
          </span>
        </a>
      </div>
    </div>
